  ...
  const newsHTML = newsList
    ...
    <div class="news">
        <a href="${item.url}" target="_blank">
            <div class="newsImg">
                <img src="${item.urlToImage}" alt="" onerror="this.src='https://t3.ftcdn.net/jpg/04/84/88/76/360_F_484887682_Mx57wpHG4lKrPAG0y7Q8Q7bJ952J3TTO.jpg'">
            </div>
            <div class="newsTxt">
                <p>${item.title}</p>
...
const paginationRender = () => {
  ...
  let paginationHtml = `<li><a href="javascript:;" onclick="movePage(${page - 1
    })">이전</a></li>`;
  ...
  paginationHtml += `<li><a href="javascript:;" onclick="movePage(${page + 1
    })">다음</a></li>`;
